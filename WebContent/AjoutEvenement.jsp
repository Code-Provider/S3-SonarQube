...
<ul class="nav nav-tabs" role = "tablist">
  <li class="nav-item" role = "tab">
    <a class="nav-link active" href="#Acc" data-toggle = "tab" role = "tab" aria-controls="Acc">Ajout d'événemet</a>
  </li>
  ...
  <form action = "AddEvenement?club_id=${club_id}&gerant_id=${gerant.id}&nom=${club}" method = "POST">
