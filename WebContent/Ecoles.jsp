...
<ul class="nav nav-tabs" role = "tablist">
  ...
  <div class="card-body">
    ...
    <p>
    <button type="button" class="float-right btn btn-danger ml-2" data-toggle="modal" data-target="#exampleModal">Supprimer</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Confirmer la suppression. Attention, tous les élèves, clubs et évenements appartenant à l'école seront supprimés.</h5>
