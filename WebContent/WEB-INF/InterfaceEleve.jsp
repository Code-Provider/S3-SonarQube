...
<ul class="nav nav-tabs" role = "tablist">
  <li class="nav-item">
    <a class="nav-link" href="#Evenements" data-toggle = "tab" role = "tab" aria-controls="Evénements">Evénements</a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link" href="#Moncompte" data-toggle = "tab" role = "tab" aria-controls="Moncompte">Mon compte</a>
  </li>
  ...
  <h5 class = "text-center">Bienvenue ${sessionScope.nom} !</h5>
   </div>
   <div class="tab-pane fade p-3" id="Evenements" aria-labelledby="Evenements-tab" role="tabpanel">
   <h5> </h5>
   </div>
   <div class="tab-pane fade p-3" id="Clubs" aria-labelledby="Clubs-tab" role="tabpanel">
   </div>
   <div class="tab-pane fade p-3" id="Moncompte" aria-labelledby="Moncompte-tab" role="tabpanel">
