...
<ul class="nav nav-tabs" role = "tablist">
  ...
  <button class="btn btn-primary" onclick="#">Deconnexion</button>
  </li>
  ...
  <label for="Description">Description</label>
    <input type="text" class="form-control" id="InputDes" name = "description" placeholder="Entrez une description de votre club">
  	...
  	<div class="form-group">
    <label for="InputDate">Logo</label>
    <input type="text" class="form-control" id="InputLogo" name = "logo" placeholder="Entrez une URL d'un logo de votre club">
  	</div>
